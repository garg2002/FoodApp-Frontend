    ...
    <div className=" bg-white h-20 flex items-center justify-between px-4 md:px-8 text-gray-600">
      ...
      <div className="hidden md:flex items-center space-x-4 ml-auto">
        ...
        >
          ...
          {items.length > 0 && (
            <span className="ml-1 text-[#1a8cff] rounded-full px-2 border-2
        ...
        {user ? (
          <>
            ...
            <button
              className="flex bg-black text-white border-2 border-gray-200 items-center py-1 px-1 w-16 rounded-md font-bold hover:bg-red-500 hover:border-gray-200 hover:border-2 hover:text-white"
          ...
          <Link
            to={`/login`}
            className="flex text-black items-center  py-1 px-1 w-16 rounded-md font-medium hover:bg-red-500 hover:text-white"
          >
            <CgProfile className="text-2xl" />
            <span className="ml-1 text-xl">Login</span>
          </Link>
        )}
      </div>
